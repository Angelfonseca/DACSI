...
\begin{itemize} 
    ...
    \item \textbf{¿Cuál es el presupuesto y el cronograma para la implementación del sistema?} \ El sistema debe entregarse en conjunto con el termino de la materia "DACSII". 
\end{itemize}