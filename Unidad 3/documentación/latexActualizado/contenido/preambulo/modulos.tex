...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{imagenes/contenido/Casos_uso.png}
    \caption{Casos de uso.}
\end{figure}

\section{Modelos de Entidad Relación}
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{imagenes/contenido/ER.png}
    \caption{Modelo de Entidad Relación del Sistema.}
\end{figure}

\section{Diagrama de Tablas}
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{imagenes/contenido/Tablas.png}
